...
def main():
    ...
    model.to(device)
    model.load_state_dict(torch.load("exp/models/mfcc/MULTITASK_model_24.pth")["model_state_dict"])
    print(model)
    ...
    tone_acc, pinyin_acc, loss = trainer.validate()
    print("tone_acc: ", tone_acc, " pinyin_acc: ", pinyin_acc, " loss: ", loss.item())
